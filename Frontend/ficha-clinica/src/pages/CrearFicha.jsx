// src/pages/CrearFicha.jsx (Corregido)
...
export default function CrearFicha() {
  ...
  return (
    <div>
      {/* <Navbar titulo="Nueva Ficha Clínica" /> ELIMINADO */}
        ...
        <div className={styles.formSection}>
          ...
          <div className={styles.formGrid}>
            <div>
              ...
              <input id="rut" name="rut" className={styles.input} value={ficha.datos_personales.rut} onChange={(e) => handleChange("datos_personales", "rut", e.target.value)} required />
            </div>
            <div>
        ...
        <div className={styles.formSection}>
          ...
          <div className={styles.formGrid}>
            <div>
              ...
              <input id="habitacion" name="habitacion" className={styles.input} value={ficha.ubicacion.habitacion} onChange={(e) => handleChange("ubicacion", "habitacion", e.target.value)} />
            </div>
            <div>
              <label htmlFor="ingresa_desde" className={styles.label}>Ingresa desde</label>
              <select id="ingresa_desde" name="ingresa_desde" className={styles.select} value={ficha.ubicacion.ingresa_desde} onChange={(e) => handleChange("ubicacion", "ingresa_desde", e.target.value)} >
                <option value="">Seleccione...</option>
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              <label htmlFor="motivo_institucionalizacion" className={styles.label}>Motivo de institucionalización</label>
              <textarea id="motivo_institucionalizacion" name="motivo_institucionalizacion" className={styles.textarea} value={ficha.ubicacion.motivo_institucionalizacion} onChange={(e) => handleChange("ubicacion", "motivo_institucionalizacion", e.target.value)} />
            </div>
          </div>
        </div>
